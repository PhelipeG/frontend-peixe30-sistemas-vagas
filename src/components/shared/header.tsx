    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16">
          {/* Logo */}
          <Link href="/jobs" className="flex items-center space-x-2 flex-shrink-0">
            <div className="bg-blue-600 p-1.5 sm:p-2 rounded-lg">
              <Briefcase className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
            </div>
            <span className="text-lg sm:text-xl font-bold text-gray-900">Peixe 30</span>
          </Link>
          ...
          <div className="hidden sm:flex items-center space-x-4">
            <div className="flex items-center space-x-2 text-sm text-gray-700">
              ...
              <span className="truncate max-w-32 lg:max-w-none">{user?.name || user?.email}</span>
            </div>
            <Button
              variant="ghost"
              size="sm"
