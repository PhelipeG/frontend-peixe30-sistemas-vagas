...
import { Mail, Briefcase, Award, CheckCircle } from 'lucide-react';
...
export function CandidateCard({ candidate, onInvite, isInviting }: CandidateCardProps) {
    ...
    <Card className="hover:shadow-md transition-shadow">
      <CardHeader>
        <div className="flex justify-between items-start">
          ...
          <div className={`px-3 py-1 rounded-full border-2 ${getScoreColor(candidate.score)}`}>
        ...
        <p className="text-sm text-muted-foreground">{getScoreLabel(candidate.score)}</p>
      </CardHeader>
